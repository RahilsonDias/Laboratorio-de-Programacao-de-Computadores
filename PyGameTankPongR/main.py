...
from modules.collision import collision_tank_or_ball
from modules.config import *
from modules.tank import Tank
from modules.ball import Ball
from modules.draw_elements import draw_arena
from modules.draw_elements import draw_walls
from modules.draw_elements import victory_texts
from modules.draw_elements import hud
from modules.draw_elements import draw_menu1
from modules.draw_elements import draw_menu2
...
menu = True
ask = 2
font = pygame.font.Font("font/PressStart2P.ttf", 25)
while menu:
    screen.fill(black)
    draw_menu1("sprites/arena1.png", "sprites/arena2.png", screen, font)
...
while menu:
    screen.fill(black)
    draw_menu2("sprites/tank1.png", "sprites/tank2.png", "sprites/tank3.png", "sprites/tank4.png", screen, font)
    for event in pygame.event.get():
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_2:
                number_of_tank = 2
...
# creat arena
if ask == 1:
    arena = draw_arena("arenas/Arena_1")
    obstacle_color = gray
    arena_color = green
else:
    arena = draw_arena("arenas/Arena_2")
...
# creat tank
list_name_archive_tank = ["sprites/tank1.png", "sprites/tank2.png", "sprites/tank3.png", "sprites/tank4.png"]
list_name_archive_ball = ["sprites/bala1.png", "sprites/bala2.png", "sprites/bala3.png", "sprites/bala4.png"]
list_of_tank = []
n = 0
...
# victory texts
font = pygame.font.Font("font/PressStart2P.ttf", 45)
...
# sounds
shoot_sound = pygame.mixer.Sound("sounds/tiger.wav")
tank_explode = pygame.mixer.Sound("sounds/tank_explode.wav")
bounce_ball = pygame.mixer.Sound("sounds/bounce_ball.wav")
tank_walk = pygame.mixer.Sound("sounds/tank_walk.wav")
...
while loop_game:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            keys_down(event, list_of_tank, invisible_mode)

        if event.type == pygame.KEYUP:
            keys_up(event, list_of_tank)
