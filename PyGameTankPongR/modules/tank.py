...
class Tank:
    def __init__(
            self, photo, x, y, speed_x, speed_y, angle, trigger, spin_right, spin_left, movement, speed_angle, life,
            ide, time_to_recharge, recharge, color, time_of_visibility, animation, animation_time, remove):
        ...
        self.y_origin = y
        self.list_ball = []
        self.vector = pygame.Vector2(speed_x, speed_y)
        self.angle = angle
